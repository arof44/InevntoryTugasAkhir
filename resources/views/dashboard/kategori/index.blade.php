        ...
        <div class="row align-items-center">
            ...
            <div class="col-6">
                <div class="text-end upgrade-btn">
                    <a href="#" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#tambahKategori">
                            ...
                            <table class="table" id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if(Auth::check())
                                        <td>
                                            <a href="#" class="btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#editKategori{{$item->id}}">
                                                <i class="fa fa-edit" style="color: white;"></i>
                                            </a>
                                            &nbsp;
                                            <a href="#" class="btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteKategori{{$item->id}}">
